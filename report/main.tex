...
erfolgt die Bereinigung durch Entfernung von HTML-Tags, URLs, Zahlen und
Satzzeichen. Der bereinigte Text wird mittels NLTK tokenisiert, wobei
...
Machine-Learning-Modelle wurde \textbf{TF-IDF} (Term Frequency-Inverse Document Frequency)
gewählt. Diese Entscheidung basiert auf mehreren Faktoren: TF-IDF ist für
Sentiment-Klassifikation bewährt, ermöglicht schnelles Training ohne GPU und bietet
Interpretierbarkeit. Die Konfiguration der TF-IDF-Vektorisierung ist in
...
Konvertierung zu Kleinbuchstaben, Entfernung von HTML-Tags, URLs, Zahlen
...
zwischen TF-IDF-Vektorisierung und einfacher Count-Vektorisierung (Bag-of-Words)
...
(50,73\% vs. 50,36\%), was die ausgeglichenere Klassifikation widerspiegelt.
...
für GPU-Training optimiert: Batch-Größe 32, fünf Epochen, FP16-Präzision
...
Machine-Learning-Verfahren (Logistic Regression, Naive Bayes, SVM,
